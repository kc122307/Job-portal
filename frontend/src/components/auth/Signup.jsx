      ...
      <div className="flex items-center justify-center max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="my-2">
            ...
            <Input type="text" value={input.fullname} name="fullname" onChange={changeEventHandler} placeholder="Kunal" />
          </div>
          <div className="my-2">
            <Label>Email</Label>
          ...
          <div className="my-2">
            ...
            <Input type="text" placeholder="" value={input.phoneNumber} name="phoneNumber" onChange={changeEventHandler} />
          </div>
          <div className="my-2">
            <Label>Password</Label>
            <Input type="password" value={input.password} placeholder="" name="password" onChange={changeEventHandler} />
          </div>
